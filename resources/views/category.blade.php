        ...
        <div class="history-top">
            ...
            <div class="hs-large">
                <a href="{{ route('news.show', [$f0->category->slug, $f0->encode_title]) }}" title="{{ $f0->news_title }}">
                    <img src="{{ url('https://financial-journal.xyz/newspaper/cms/public/uploads/' . $f0->photo) }}" alt="{{ $f0->news_title }}">
                </a>
            ...
            <div class="hs-right">
                <a href="{{ route('news.show', [$f1->category->slug, $f1->encode_title]) }}" title="{{ $f1->news_title }}">
                    <img src="{{ url('https://financial-journal.xyz/newspaper/cms/public/uploads/' . $f1->photo) }}" alt="{{ $f1->news_title }}">
                </a>
