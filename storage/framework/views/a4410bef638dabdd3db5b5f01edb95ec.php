...
<?php if (! empty(trim($__env->yieldContent('article_author')))): ?>
...
<?php if (! empty(trim($__env->yieldContent('published_time')))): ?>
...
<?php /**PATH C:\Users\Muhammad Ramshad\Downloads\illuminated_updated\illuminated_updated\resources\views/layouts/app.blade.php ENDPATH**/ ?>