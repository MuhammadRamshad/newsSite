...
<?php $__env->startSection('title', 'Illuminated Magazine — Art, History, Science & Discoveries'); ?>
...
<?php $__env->startSection('keywords', 'illuminated magazine, art, discoveries, history, science, culture, travel, stories'); ?>
<?php $__env->startSection('canonical', url('/')); ?>
<?php $__env->startSection('og_image', asset('assets/images/foxiz.webp')); ?>
    ...
    <div class="feature-wrap">
        ...
        <div class="fa-left">
            ...
            <div class="fa-card">
                <a href="<?php echo e(route('news.show', [$featureLeft->category->slug, $featureLeft->encode_title])); ?>" title="<?php echo e($featureLeft->news_title); ?>">
                    <img src="<?php echo e(asset('assets/images/uploads/' . $featureLeft->photo)); ?>" alt="<?php echo e($featureLeft->news_title); ?>">
                </a>
        ...
        <div class="fa-center">
            ...
            <div class="fa-main">
                <a href="<?php echo e(route('news.show', [$featureMain->category->slug, $featureMain->encode_title])); ?>" title="<?php echo e($featureMain->news_title); ?>">
                    <img src="<?php echo e(asset('assets/images/uploads/' . $featureMain->photo)); ?>" alt="<?php echo e($featureMain->news_title); ?>">
                </a>
        ...
        <div class="fa-right">
            ...
            <div class="fa-follow">
                ...
                <div class="fa-icons">
                    <a href="#" title="Follow us on Instagram"><img src="<?php echo e(asset('assets/image/insta.webp')); ?>" alt="Instagram"></a>
                    <a href="#" title="Follow us on Facebook"><img src="<?php echo e(asset('assets/image/insta.webp')); ?>" alt="Facebook"></a>
                    <a href="#" title="Follow us on Twitter"><img src="<?php echo e(asset('assets/image/insta.webp')); ?>" alt="Twitter"></a>
                    <a href="#" title="Follow us on YouTube"><img src="<?php echo e(asset('assets/image/insta.webp')); ?>" alt="YouTube"></a>
                    <a href="#" title="Subscribe to our RSS Feed"><img src="<?php echo e(asset('assets/image/insta.webp')); ?>" alt="RSS"></a>
                    <a href="#" title="Support us on Patreon"><img src="<?php echo e(asset('assets/image/insta.webp')); ?>" alt="Patreon"></a>
                </div>
            </div>
        </div>
    ...
    <div class="lf-wrapper">
        ...
        <div class="lf-sidebar">
            ...
            <div class="lf-side-item">
                <a href="<?php echo e(route('category.show', $cat->slug)); ?>" title="<?php echo e($cat->category_name); ?>">
                ...
                <p><a href="<?php echo e(route('category.show', $cat->slug)); ?>" title="Discover more <?php echo e($cat->category_name); ?> stories">Discover More →</a></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
<section class="ad-banner-section">
    <div class="ad-banner-wrap">
        <a href="#" title="Advertisement"><img src="<?php echo e(asset('assets/image/ad.webp')); ?>" alt="Advertisement"></a>
    </div>
</section>
        ...
        <div class="pd-grid">
            ...
            <div class="pd-col">
                ...
                <a href="<?php echo e(route('news.show', [$photoOfDay->get(0)->category->slug, $photoOfDay->get(0)->encode_title])); ?>" title="<?php echo e($photoOfDay->get(0)->news_title); ?>">
                    <img src="<?php echo e(asset('assets/images/uploads/' . $photoOfDay->get(0)->photo)); ?>" class="pd-img-tall-full" alt="<?php echo e($photoOfDay->get(0)->news_title); ?>">
                </a>
                <?php endif; ?>
            </div>
            <!-- Column 2 -->
            <div class="pd-col">
                ...
                <a href="<?php echo e(route('news.show', [$photoOfDay->get(1)->category->slug, $photoOfDay->get(1)->encode_title])); ?>" title="<?php echo e($photoOfDay->get(1)->news_title); ?>">
                    <img src="<?php echo e(asset('assets/images/uploads/' . $photoOfDay->get(1)->photo)); ?>" class="pd-img-large" alt="<?php echo e($photoOfDay->get(1)->news_title); ?>">
                </a>
                <?php endif; ?>
                ...
                <a href="<?php echo e(route('news.show', [$photoOfDay->get(2)->category->slug, $photoOfDay->get(2)->encode_title])); ?>" title="<?php echo e($photoOfDay->get(2)->news_title); ?>">
                    <img src="<?php echo e(asset('assets/images/uploads/' . $photoOfDay->get(2)->photo)); ?>" class="pd-img-medium" alt="<?php echo e($photoOfDay->get(2)->news_title); ?>">
                </a>
                <?php endif; ?>
            </div>
            <!-- Column 3 -->
            <div class="pd-col">
                ...
                <a href="<?php echo e(route('news.show', [$photoOfDay->get(3)->category->slug, $photoOfDay->get(3)->encode_title])); ?>" title="<?php echo e($photoOfDay->get(3)->news_title); ?>">
                    <img src="<?php echo e(asset('assets/images/uploads/' . $photoOfDay->get(3)->photo)); ?>" class="pd-img-small" alt="<?php echo e($photoOfDay->get(3)->news_title); ?>">
                </a>
                <?php endif; ?>
                ...
                <a href="<?php echo e(route('news.show', [$photoOfDay->get(4)->category->slug, $photoOfDay->get(4)->encode_title])); ?>" title="<?php echo e($photoOfDay->get(4)->news_title); ?>">
                    <img src="<?php echo e(asset('assets/images/uploads/' . $photoOfDay->get(4)->photo)); ?>" class="pd-img-tall" alt="<?php echo e($photoOfDay->get(4)->news_title); ?>">
                </a>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="history-top">
            ...
            <div class="hs-large">
                <a href="<?php echo e(route('news.show', [$h0->category->slug, $h0->encode_title])); ?>" title="<?php echo e($h0->news_title); ?>">
                    <img src="<?php echo e(asset('assets/images/uploads/' . $h0->photo)); ?>" alt="<?php echo e($h0->news_title); ?>">
                </a>
            ...
            <div class="hs-right">
                <a href="<?php echo e(route('news.show', [$h1->category->slug, $h1->encode_title])); ?>" title="<?php echo e($h1->news_title); ?>">
                    <img src="<?php echo e(asset('assets/images/uploads/' . $h1->photo)); ?>" alt="<?php echo e($h1->news_title); ?>">
                </a>
            ...
            <div class="ac-column">
                ...
                <div class="ac-card">
                    <a href="<?php echo e(route('news.show', [$a0->category->slug, $a0->encode_title])); ?>" title="<?php echo e($a0->news_title); ?>">
                        <img src="<?php echo e(asset('assets/images/uploads/' . $a0->photo)); ?>" class="ac-img-tall" alt="<?php echo e($a0->news_title); ?>">
                    </a>
                    <div class="ac-text">
                        <h3><a href="<?php echo e(route('news.show', [$a0->category->slug, $a0->encode_title])); ?>" title="<?php echo e($a0->news_title); ?>"><?php echo e($a0->news_title); ?></a></h3>
                ...
                <div class="ac-card">
                    <a href="<?php echo e(route('news.show', [$a1->category->slug, $a1->encode_title])); ?>" title="<?php echo e($a1->news_title); ?>">
                        <img src="<?php echo e(asset('assets/images/uploads/' . $a1->photo)); ?>" class="ac-img-short" alt="<?php echo e($a1->news_title); ?>">
                    </a>
                    <div class="ac-text">
                        <h3><a href="<?php echo e(route('news.show', [$a1->category->slug, $a1->encode_title])); ?>" title="<?php echo e($a1->news_title); ?>"><?php echo e($a1->news_title); ?></a></h3>
            ...
            <div class="ac-column">
                ...
                <div class="ac-card">
                    <a href="<?php echo e(route('news.show', [$a2->category->slug, $a2->encode_title])); ?>" title="<?php echo e($a2->news_title); ?>">
                        <img src="<?php echo e(asset('assets/images/uploads/' . $a2->photo)); ?>" class="ac-img-short" alt="<?php echo e($a2->news_title); ?>">
                    </a>
                    <div class="ac-text">
                        <h3><a href="<?php echo e(route('news.show', [$a2->category->slug, $a2->encode_title])); ?>" title="<?php echo e($a2->news_title); ?>"><?php echo e($a2->news_title); ?></a></h3>
                ...
                <div class="ac-card">
                    <a href="<?php echo e(route('news.show', [$a3->category->slug, $a3->encode_title])); ?>" title="<?php echo e($a3->news_title); ?>">
                        <img src="<?php echo e(asset('assets/images/uploads/' . $a3->photo)); ?>" class="ac-img-tall" alt="<?php echo e($a3->news_title); ?>">
                    </a>
                    <div class="ac-text">
                        <h3><a href="<?php echo e(route('news.show', [$a3->category->slug, $a3->encode_title])); ?>" title="<?php echo e($a3->news_title); ?>"><?php echo e($a3->news_title); ?></a></h3>
            ...
            <div class="ac-column">
                ...
                <div class="ac-card ac-image-only">
                    <a href="<?php echo e(route('news.show', [$a4->category->slug, $a4->encode_title])); ?>" title="<?php echo e($a4->news_title); ?>">
                        <img src="<?php echo e(asset('assets/images/uploads/' . $a4->photo)); ?>" class="ac-img-large" alt="<?php echo e($a4->news_title); ?>">
                    </a>
                </div>
                <?php endif; ?>
                ...
                <div class="ac-card ac-image-only">
                    <a href="<?php echo e(route('news.show', [$a5->category->slug, $a5->encode_title])); ?>" title="<?php echo e($a5->news_title); ?>">
                        <img src="<?php echo e(asset('assets/images/uploads/' . $a5->photo)); ?>" class="ac-img-medium" alt="<?php echo e($a5->news_title); ?>">
                    </a>
                </div>
                <?php endif; ?>
            </div>
        ...
        <div class="discover-grid">
            ...
            <div class="dc-left">
                <a href="<?php echo e(route('news.show', [$d0->category->slug, $d0->encode_title])); ?>" title="<?php echo e($d0->news_title); ?>">
                    <img src="<?php echo e(asset('assets/images/uploads/' . $d0->photo)); ?>" alt="<?php echo e($d0->news_title); ?>">
                </a>
            ...
            <div class="dc-middle">
                <a href="<?php echo e(route('news.show', [$d1->category->slug, $d1->encode_title])); ?>" title="<?php echo e($d1->news_title); ?>">
                    <img src="<?php echo e(asset('assets/images/uploads/' . $d1->photo)); ?>" alt="<?php echo e($d1->news_title); ?>">
                </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/myapiusa/public_html/ramshad/new/resources/views/index.blade.php ENDPATH**/ ?>